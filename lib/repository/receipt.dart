...
//////others///////
  ...
  Future<List<int>> transactionReceipt(
    ...
    //Divider
    bytes += ticket.hr();
    bytes += ticket.text('--Total Items $totalitems--',
        styles: const PosStyles(align: PosAlign.center, bold: true));
    bytes += ticket.hr();
    //Summary
    ...
    bytes += ticket.hr();
    //Customer Info
    bytes += ticket.text('Name:\t__________________________',
        styles: const PosStyles(align: PosAlign.left, bold: true));
    bytes += ticket.text('Addr:\t__________________________',
        styles: const PosStyles(align: PosAlign.left, bold: true));
    bytes += ticket.text('TIN:\t__________________________',
        styles: const PosStyles(align: PosAlign.left, bold: true));
    bytes += ticket.text('Style:\t__________________________',
        styles: const PosStyles(align: PosAlign.left, bold: true));
    // //Divider
    // ticket.hr();
    // //Message
    // ticket.text('Thank you! Come again!',
    //     styles: const PosStyles(align: PosAlign.center, bold: true),
    //     linesAfter: 2);
    // ticket.text('THIS IS A OFFICIAL RECEIPT',
    //     styles: const PosStyles(align: PosAlign.center, bold: true),
    //     linesAfter: 2);
    //Divider
    if (promodetails != '') bytes += ticket.hr();
    //Promo
    bytes += ticket.text(promodetails,
        styles: const PosStyles(align: PosAlign.center, bold: true));
